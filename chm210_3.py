...
# gas constant (in useful units)
    ...
    pEpH.plot(pE_Fe3_Fe2_pH, pE_Fe3_Fe2_new, 'b-', label='$Fe^{3+}$:$Fe^{2+}$')
    pEpH.text(1, 5, '$Fe^{2+}$')
    pEpH.plot(pH_FeOH3_Fe3_pH, pH_FeOH3_Fe3_pE, 'r-', label='$Fe^{3+}$:$FeOH_3$')
    pEpH.text(1, 17, '$Fe^{3+}$')
    pEpH.plot(pE_FeOH3_Fe2_pH, pE_FeOH3_Fe2_new, 'o-', label='$Fe^{3+}$:$Fe^{2+}$')
    pEpH.text(12, 0, '$Fe(OH)_3$')
    pEpH.plot(pH_FeOH2_Fe2_pH, pH_FeOH2_Fe2_pE, 'g-', label='$Fe^{2+}$:$FeOH_2$')
    pEpH.plot(pE_FeOH3_FeOH2_pH, pE_FeOH3_FeOH2_new, 'r-', label='$Fe^{3+}$:$Fe^{2+}$')
